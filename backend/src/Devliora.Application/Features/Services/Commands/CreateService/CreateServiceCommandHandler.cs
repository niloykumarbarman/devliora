...
public class CreateServiceCommandHandler : IRequestHandler<CreateServiceCommand, Guid>
{
    ...
    public async Task<Guid> Handle(CreateServiceCommand request, CancellationToken cancellationToken)
    {
        var service = new Service
        {
            ...
            AiServicesImageUrl = request.AiServicesImageUrl,
            AdvancedTechnologiesImageUrl = request.AdvancedTechnologiesImageUrl,
            DisplayOrder = request.DisplayOrder,
            HighlightsHeading = request.HighlightsHeading,
            HighlightsDescription = request.HighlightsDescription,
