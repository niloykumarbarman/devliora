...
public class GetSiteSettingsQueryHandler : IRequestHandler<GetSiteSettingsQuery, SiteSettingsDto>
{
    ...
    public async Task<SiteSettingsDto> Handle(GetSiteSettingsQuery request, CancellationToken cancellationToken)
    {
        ...
        var result = new SiteSettingsDto
        {
            ...
            BlogHeroImageUrl = settings.BlogHeroImageUrl,
            BookConsultationHeroImageUrl = settings.BookConsultationHeroImageUrl,
            ...
            TechnologiesHeroImageUrl = settings.TechnologiesHeroImageUrl,
            TechnologiesBackendImageUrl = settings.TechnologiesBackendImageUrl,
            TechnologiesFrontendImageUrl = settings.TechnologiesFrontendImageUrl,
            TechnologiesCloudImageUrl = settings.TechnologiesCloudImageUrl,
