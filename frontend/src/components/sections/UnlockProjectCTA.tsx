...
// "Unlock the full potential of your project." — matches
// kaz.com.bd's per-technology page's mid-page CTA banner, sitting right
// after the Dedicated Development Team org-chart. Originally built only
// for the Staff Augmentation service page (services/[slug]/page.tsx);
// extracted here so other pages can reuse the same bg-signal
// split-banner pattern instead of duplicating it.
export default function UnlockProjectCTA() {
  return (
