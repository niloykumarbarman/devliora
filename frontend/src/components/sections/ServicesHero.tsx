...
// columns to match the reference layout. Only the hero image is
// admin-managed (SiteSettings.servicesImageUrl, same field the Services
// mega-menu uses) — everything else on this hero is deliberately static.
const SERVICE_LINKS = [
  [
        ...
        <div className="mt-10 grid gap-12 md:grid-cols-2 md:items-center">
          <div>
            ...
            <motion.div {...fadeUp(4)} className="mt-8 grid grid-cols-1 gap-x-8 gap-y-2 sm:grid-cols-2">
              {SERVICE_LINKS.map((column, colIndex) => (
